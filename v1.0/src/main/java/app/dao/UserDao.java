...
public class UserDao {
    ...
    public User findOne(String login, String password) throws SQLException, ClassNotFoundException {
        ...
        String sql = "select user_id from users where username='" + login + "' and password='" + password + "'";
    ...
    public void insert(User user) throws SQLException, ClassNotFoundException {
        ...
        String sql = "insert into users (username, password, phone, address, email) values('" + user.getLogin() + "', '" +
    ...
    public void updateAccount(int id, double newAccount) throws SQLException, ClassNotFoundException {
        ...
        String sql = "update users set account=" + newAccount + " where user_id=" + id;
